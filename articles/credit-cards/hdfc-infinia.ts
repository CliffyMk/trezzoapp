...
export const hdfcInfiniaArticle: Article = {
  id: 'cc-hdfc-infinia-complete',
  title: 'HDFC Bank Infinia Credit Card: Complete Review & Guide',
  excerpt: 'The legendary dream card for credit card enthusiasts. Complete guide to Infinia\'s rewards, lounge access, benefits, eligibility, and how it compares to competitors.',
  content: `

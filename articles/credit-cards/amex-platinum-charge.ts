...
export const amexPlatinumChargeArticle: Article = {
  id: 'amex-platinum-charge',
  title: 'American Express Platinum Charge Card Review - Ultra Premium Metal Card',
  excerpt: 'In-depth review of the Amex Platinum Charge Card with Marriott Gold Elite tier, hotel memberships, lifestyle benefits, and comprehensive travel concierge services.',
  date: '2024-02-01',
  readTime: '15 min',
  tags: ['credit cards', 'ultra premium', 'charge card', 'american express', 'lifestyle'],
  imageUrl: '/trezzoapp/trezzoapp/images/credit-cards/amex-mk.png',
  content: `

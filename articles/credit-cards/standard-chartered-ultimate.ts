...
export const standardCharteredUltimateArticle: Article = {
  id: 'standard-chartered-ultimate',
  title: 'Standard Chartered Ultimate Credit Card Review - Super Premium Rewards Card',
  excerpt: 'Comprehensive review of the Standard Chartered Ultimate Credit Card featuring 3.3% reward rate, unlimited redemption options, and premium lifestyle benefits.',
  date: '2024-01-15',
  readTime: '12 min',

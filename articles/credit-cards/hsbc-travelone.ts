...
export const hsbcTravelOneArticle: Article = {
  id: 'cc-hsbc-travelone',
  title: 'HSBC TravelOne Credit Card Review (India)',
  excerpt: 'A travel-focused card with uncapped transfers and decent travel rewards — best for frequent OTA/hotel bookers who use Accor and similar partners.',
  content: `

...
export const iciciBmeraldeprivateArticle: Article = {
  id: 'icici-emeralde-private',
  title: 'ICICI Emeralde Private Metal Credit Card Review - Super Premium Metal Card',
  excerpt: 'Detailed review of ICICI Emeralde Private Metal with 3% base rewards, Taj Epicure membership, unlimited lounge access, and 3.75% milestone rewards.',
  date: '2024-03-15',
  readTime: '13 min',

    ...
    <div className="animate-fade-in w-full">
      ...
      <div className="mb-16 md:mb-24 relative">
        ...
        <div className="pt-8 flex flex-col md:flex-row gap-8 items-start md:items-end justify-between">
          ...
          <div className="hidden md:block text-slate-200 dark:text-white/[0.04] transform translate-y-4">
...
const ArticlePage = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto animate-fade-in-up">
      ...
      <div className="my-16 h-px bg-slate-200 dark:bg-white/[0.08]"></div>

      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6">
        <div className="flex flex-wrap gap-2">
          {article.tags.map(tag => (
            <span key={tag} className="px-4 py-1.5 bg-transparent border border-slate-200 dark:border-white/[0.08] text-xs font-semibold text-slate-600 dark:text-slate-400 uppercase tracking-widest hover:border-gold-500 hover:text-gold-500 transition-colors cursor-default">
              #{tag}
            </span>
          ))}
        </div>
...
const HomePage = () => {
  ...
  return (
    <div className="flex flex-col w-full animate-fade-in">
      ...
      {/* Masthead */}
      <div className="flex flex-col items-center justify-center pt-12 pb-20 md:pb-28 text-center border-b border-slate-200 dark:border-white/[0.06] mb-16">
        <div className="mb-6">
        ...
        <p className="text-lg md:text-xl text-slate-600 dark:text-slate-300 max-w-2xl leading-relaxed font-light font-serif italic">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-24 bg-white dark:bg-dark-800 p-10 md:p-16 border border-slate-200 dark:border-white/[0.06] relative overflow-hidden">
        ...
        <div>
          ...
          <p className="text-slate-600 dark:text-slate-300 leading-relaxed font-light mb-8">
          ...
          <div className="flex flex-col gap-4">
            <div className="flex items-center gap-4">
              <div className="w-10 h-10 rounded-full bg-slate-100 dark:bg-white/[0.06] flex items-center justify-center text-gold-500">
                <TrendingUp size={18} />
              </div>
              <div>
        ...
        <div className="relative h-full min-h-[300px] border border-slate-200 dark:border-white/[0.08] p-2">
      ...
      {/* Newsletter / CTA */}
      <section className="text-center py-20 border-t border-slate-200 dark:border-white/[0.06]">
        ...
        <p className="text-slate-600 dark:text-slate-300 max-w-xl mx-auto mb-10 font-light">
        ...
        <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
          <input
            ...
            className="flex-1 px-6 py-4 bg-slate-50 dark:bg-dark-800 border border-slate-200 dark:border-white/[0.08] text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 focus:border-gold-500 focus:outline-none transition-colors rounded-sm"
          />
